...
// src/app/page.tsx
// Hero video + info + the new two-button wallet UX.
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* HERO video (keep your file at /public/video.mp4 or change src) */}
        <div
          style={{
            overflow: "hidden",
            borderRadius: 14,
        ...
        >
          ...
          <p style={{ margin: 0, opacity: 0.92 }}>
            Woolly Eggs — testnet mint & mini-app on Monad. Pick a wallet below:
            use <b>WalletConnect</b> for mobile/QR, or <b>Browser Wallet</b> to choose
            MetaMask / Phantom / Backpack / Rabby on desktop.
          </p>
        </div>

        {/* New two-button wallet UX */}
        <WalletButtons />
